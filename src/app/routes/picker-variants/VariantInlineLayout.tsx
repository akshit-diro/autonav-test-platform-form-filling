...
interface VariantInlineLayoutProps {
  pickerType: string
}

export function VariantInlineLayout({ pickerType }: VariantInlineLayoutProps) {
  ...
  return (
    <div data-testid="variant-inline-layout">
      <p style={{ fontSize: '0.875rem', marginBottom: '0.5rem' }}>
        Select a date range in the calendar below.
      </p>
